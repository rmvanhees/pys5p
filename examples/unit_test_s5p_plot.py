...
def main():
    ...
    if check_draw_signal:
        ...
        nlines = 50
        fig_info = FIGinfo('right')
        for ii in range(nlines):
            fig_info.add('line {:02d}'.format(ii), 'blahblahblahblahblah')
        plot.draw_signal(data, fig_info=fig_info,
                         title='Unit test of S5Pplot [draw_signal]',
        ...
        for ii in range(nlines):
            fig_info.add('line {:02d}'.format(ii), 'blahblahblahblahblah')
        plot.draw_signal(data[500-250:500+250, :], fig_info=fig_info,
                         title='Unit test of S5Pplot [draw_signal]',
        ...
        for ii in range(nlines):
            fig_info.add('line {:02d}'.format(ii), 'blahblahblahblahblah')
        plot.draw_signal(data[500-128:500+128, :], fig_info=fig_info,
                         title='Unit test of S5Pplot [draw_signal]',
